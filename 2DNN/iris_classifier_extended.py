...
if __name__ == '__main__':
    ...
    sn.add_layer({'type': 'attention', 'num_inputs': 32, 'num_outputs': 32, 'num_heads': 1, 'sequence_length': 1})
    sn.add_layer({'type': 'dense', 'num_inputs': 32, 'num_outputs': 3, 'relu': True, 'sigmoid': False, 'weights': None, 'bias': None})
